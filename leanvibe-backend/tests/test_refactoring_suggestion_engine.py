...
def test_refactoring_suggestion_creation():
    ...
    try:
        ...
        assert (
            ...
            == "Break down long method into smaller focused methods"
        )
...
async def test_analyze_file():
    ...
    try:
        ...
        # Mock ast_service
        with patch(
            "app.services.refactoring_suggestion_engine.ast_service"
        ) as mock_ast:
...
async def test_project_analysis():
    ...
    try:
        ...
        with patch(
            "app.services.refactoring_suggestion_engine.project_indexer"
        ) as mock_indexer:
...
if __name__ == "__main__":
    ...
    sync_tests = [
        (
            "Refactoring Suggestion Engine Imports",
            test_refactoring_suggestion_engine_imports,
        ),
