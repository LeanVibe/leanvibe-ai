...
def test_cache_warming_service_basic():
    ...
    try:
        from app.services.cache_warming_service import cache_warming_service, SmartCacheWarmingService
...
def test_cache_warming_models():
    ...
    try:
        from app.services.cache_warming_service import ProjectUsageStats, CacheWarmingStrategy, WarmingTask
...
def test_cache_warming_configuration():
    ...
    try:
        ...
        expected_metrics = [
            "total_warming_tasks", "successful_warmings", "failed_warmings",
            "average_warming_time", "total_projects_tracked", "background_warming_active",
            "queue_size", "active_tasks", "completed_tasks", "current_strategy"
        ]
...
if __name__ == "__main__":
    ...
    tests = [
        ...
        ("Incremental Indexer Warming Integration", test_incremental_indexer_warming_integration),
        ("Session Manager Warming Integration", test_session_manager_warming_integration),
