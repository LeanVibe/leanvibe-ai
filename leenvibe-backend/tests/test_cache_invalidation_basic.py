...
def test_cache_invalidation_service_basic():
    ...
    try:
        from app.services.cache_invalidation_service import cache_invalidation_service, CacheInvalidationService
        ...
        expected_metrics = [
            "total_invalidations", "cascade_invalidations", "symbol_based_invalidations",
            "external_dependency_invalidations", "average_propagation_depth", 
            "cache_coherency_events", "dependency_graph_size", "symbol_mappings",
            "import_mappings", "recent_events"
        ]
...
def test_cache_invalidation_models():
    ...
    try:
        from app.services.cache_invalidation_service import InvalidationEvent, DependencyNode
...
def test_file_monitor_integration():
    ...
    try:
        ...
        trigger_method = getattr(file_monitor_service, '_trigger_incremental_index_update')
