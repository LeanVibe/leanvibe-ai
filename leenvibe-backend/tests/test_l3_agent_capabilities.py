...
class TestL3AgentFramework:
    ...
    async def test_agent_context_management(self):
        ...
        from app.agent.l3_coding_agent import L3CodingAgent, AgentDependencies, AgentState
    ...
    async def test_agent_mock_responses(self):
        ...
        from app.agent.l3_coding_agent import L3CodingAgent, AgentDependencies, SimpleMLXModel
        from app.services.ai_service import AIService
        ...
        mock_ai_service._generate_mock_response = AsyncMock(return_value="Mock response for testing")
