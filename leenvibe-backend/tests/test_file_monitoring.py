...
class TestMonitoringModels:
    ...
    def test_monitoring_session(self):
        ...
        from app.models.monitoring_models import (
            MonitoringSession, MonitoringConfiguration, 
            MonitoringStatus, FileChange, ChangeType
        )
    ...
    def test_impact_assessment(self):
        ...
        from app.models.monitoring_models import ImpactAssessment, RiskLevel, ChangeScope
...
class TestFileMonitorService:
    ...
    async def test_monitoring_configuration_validation(self):
        ...
        from app.services.file_monitor_service import file_monitor_service
        from app.models.monitoring_models import MonitoringConfiguration, MonitoringError
    ...
    async def test_monitoring_session_lifecycle(self):
        ...
        from app.services.file_monitor_service import file_monitor_service
        from app.models.monitoring_models import MonitoringConfiguration, MonitoringStatus
    ...
    def test_file_pattern_matching(self):
        ...
        from app.services.file_monitor_service import FileMonitorEventHandler
        from app.models.monitoring_models import MonitoringConfiguration
        from app.services.file_monitor_service import file_monitor_service
        ...
        # Should ignore
        assert handler._should_monitor_file("/test/__pycache__/file.pyc", config) == False
        assert handler._should_monitor_file("/test/node_modules/lib.js", config) == False
...
''')
            ...
            if result["status"] == "success":
                ...
                assert changes_result["status"] == "success" or changes_result["status"] == "error"
                
                # Test stopping monitoring
                stop_result = await agent._stop_monitoring_tool()
                assert stop_result["status"] == "success" or stop_result["status"] == "error"
...
''')
            ...
            for query in test_queries:
                ...
                if "Error" in response:
                    ...
                    assert "monitoring" in response.lower() or "session" in response.lower()
...
def test_monitoring_basic_functionality():
    ...
    from app.services.file_monitor_service import file_monitor_service
    from app.models.monitoring_models import MonitoringConfiguration, FileChange, ChangeType
...
if __name__ == "__main__":
    ...
    asyncio.run(TestEnhancedAgentMonitoringIntegration().test_enhanced_state_includes_monitoring_capabilities())
