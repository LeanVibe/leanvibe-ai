...
class TestCodeCompletionEndpoint:
    ...
    def test_intent_defaults_to_suggest(self, test_client):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_suggest_code_tool = AsyncMock(return_value=json.dumps(mock_response))
    ...
    @pytest.mark.asyncio
    async def test_suggest_intent_endpoint(self, async_client, sample_python_request, mock_enhanced_agent_response):
        """Test suggest intent calls correct MLX tool"""
        sample_python_request["intent"] = "suggest"
        
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_suggest_code_tool = AsyncMock(return_value=json.dumps(mock_enhanced_agent_response))
            
            response = await async_client.post("/api/code-completion", json=sample_python_request)
    ...
    @pytest.mark.asyncio
    async def test_explain_intent_endpoint(self, async_client, sample_javascript_request):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_explain_code_tool = AsyncMock(return_value=json.dumps(explain_response))
            
            response = await async_client.post("/api/code-completion", json=sample_javascript_request)
    ...
    async def test_refactor_intent_endpoint(self, async_client, sample_python_request):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_refactor_code_tool = AsyncMock(return_value=json.dumps(refactor_response))
    ...
    async def test_debug_intent_endpoint(self, async_client, sample_python_request):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_debug_code_tool = AsyncMock(return_value=json.dumps(debug_response))
    ...
    async def test_optimize_intent_endpoint(self, async_client, sample_python_request):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            mock_agent._mlx_optimize_code_tool = AsyncMock(return_value=json.dumps(optimize_response))
    ...
    @pytest.mark.asyncio
    async def test_handles_agent_errors_gracefully(self, async_client, sample_python_request):
        """Test endpoint handles agent errors gracefully"""
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            # Simulate agent error
            mock_agent._mlx_suggest_code_tool = AsyncMock(side_effect=Exception("Agent error"))
    ...
    @pytest.mark.asyncio
    async def test_handles_invalid_agent_response(self, async_client, sample_python_request):
    ...
    @pytest.mark.asyncio
    async def test_handles_agent_error_responses(self, async_client, sample_python_request):
    ...
    @pytest.mark.asyncio
    async def test_response_includes_processing_time(self, async_client, sample_python_request, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_response_includes_all_required_fields(self, async_client, sample_python_request, mock_enhanced_agent_response):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            ...
            # Required fields
            required_fields = [
                "status", "intent", "response", "confidence", 
                "requires_review", "suggestions", "context_used",
                "processing_time_ms"
            ]
    ...
    @pytest.mark.asyncio
    async def test_confidence_score_in_valid_range(self, async_client, sample_python_request, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_file_content_in_request(self, async_client, sample_python_request, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_language_parameter(self, async_client, sample_python_request, mock_enhanced_agent_response):
        ...
        with patch('app.api.endpoints.code_completion.enhanced_agent') as mock_agent:
            ...
            assert data.get("language") == "python" or data.get("context_used", {}).get("language") == "python"
    ...
    @pytest.mark.asyncio
    async def test_response_time_under_threshold(self, async_client, sample_python_request, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_negative_cursor_position(self, async_client, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_very_large_cursor_position(self, async_client, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_special_characters_in_file_path(self, async_client, mock_enhanced_agent_response):
    ...
    @pytest.mark.asyncio
    async def test_handles_concurrent_requests(self, async_client, sample_python_request, mock_enhanced_agent_response):
