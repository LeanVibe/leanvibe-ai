...
def test_graph_update_batch_creation():
    ...
    try:
        from app.services.incremental_graph_service import (
            GraphUpdateBatch, GraphChange, GraphUpdateType
        )
...
def test_service_initialization():
    ...
    try:
        ...
        expected_metrics = [
            ...
            "nodes_added", "nodes_updated", "nodes_deleted",
            "relationships_added", "relationships_updated", "relationships_deleted",
            "average_propagation_time_ms", "max_propagation_depth_reached"
        ]
        ...
        expected_relationships = [
            "import", "call", "inheritance", "contains", "defines", "references", "depends_on"
        ]
...
async def test_process_file_changes_basic(mock_graph_service):
    ...
    try:
        from app.services.incremental_graph_service import incremental_graph_service, PropagationResult
        ...
        with patch.object(incremental_graph_service, '_build_basic_file_update', return_value=[]):
            with patch.object(incremental_graph_service, '_apply_update_batch', return_value=True):
                with patch.object(incremental_graph_service, '_propagate_relationship_changes') as mock_propagate:
...
if __name__ == "__main__":
    ...
    # Async tests
    async_tests = [
        ("Process File Changes Basic", test_process_file_changes_basic)
    ]
