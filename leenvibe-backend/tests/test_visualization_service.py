...
class TestVisualizationModels:
    ...
    def test_diagram_configuration_creation(self):
        ...
        from app.models.visualization_models import (
            DiagramConfiguration, DiagramType, DiagramTheme, DiagramLayout
        )
    ...
    def test_diagram_data_creation(self):
        ...
        from app.models.visualization_models import (
            DiagramData, DiagramNode, DiagramEdge, DiagramConfiguration, DiagramType
        )
        ...
        edges = [
            DiagramEdge(id="edge1", source_id="node1", target_id="node2", type="depends")
        ]
    ...
    def test_mermaid_diagram_creation(self):
        ...
        from app.models.visualization_models import MermaidDiagram, DiagramTheme
    ...
    def test_diagram_generation_request(self):
        ...
        from app.models.visualization_models import (
            DiagramGenerationRequest, DiagramConfiguration, 
            DiagramType, DiagramExportFormat
        )
...
''')
            ...
            for query in test_queries:
                ...
                if "Error" in response:
                    ...
                    assert "diagram" in response.lower() or "visualization" in response.lower()
    ...
    async def test_enhanced_state_includes_visualization_capabilities(self):
        ...
        deps = AgentDependencies(
            workspace_path=".",
            client_id="test-state-viz-client",
            session_data={}
        )
        ...
        expected_capabilities = [
            "interactive_diagrams", "multiple_diagram_types", 
            "theme_support", "mermaid_generation"
        ]
...
class TestMermaidGeneration:
    ...
    def test_mermaid_template_rendering(self):
        ...
        from app.services.visualization_service import visualization_service
        from app.models.visualization_models import (
            DiagramData, DiagramNode, DiagramEdge, DiagramConfiguration,
            DiagramType, DiagramLayout
        )
        ...
        edges = [
            DiagramEdge(id="dep1", source_id="fileA", target_id="fileB", type="dependency"),
            DiagramEdge(id="dep2", source_id="fileB", target_id="fileC", type="dependency")
        ]
        ...
        try:
            ...
            template_str = visualization_service.templates.get(DiagramType.DEPENDENCY_GRAPH)
            ...
            print(f"Template rendering test - expected if Jinja2 not fully configured: {e}")
...
if __name__ == "__main__":
    ...
    asyncio.run(TestVisualizationIntegration().test_enhanced_state_includes_visualization_capabilities())
