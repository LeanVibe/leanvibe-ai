...
class SimpleCodeModel(nn.Module):
    ...
    def __init__(self, vocab_size: int = 32000, hidden_size: int = 512, num_layers: int = 4):
        super().__init__()
...
class SimpleModelService:
    ...
    def __init__(self):
        ...
        self.vocab = {
            "<pad>": 0, "<unk>": 1, "<s>": 2, "</s>": 3,
            "def": 10, "class": 11, "import": 12, "from": 13,
            "if": 20, "else": 21, "for": 22, "while": 23,
            "print": 30, "return": 31, "self": 32, "True": 33, "False": 34,
            "(": 40, ")": 41, "{": 42, "}": 43, "[": 44, "]": 45,
            ":": 50, ",": 51, ".": 52, "=": 53, "+": 54, "-": 55,
            " ": 60, "\n": 61, "\t": 62
        }
