...
class ProjectIndexer:
    ...
    async def _analyze_file_batch(self, file_paths: List[str]) -> Dict[str, FileAnalysis]:
    ...
    def _resolve_module_path(self, module_name: str, source_file: str, workspace_path: str) -> Optional[str]:
    ...
    async def update_file_index(self, project_index: ProjectIndex, file_path: str) -> bool:
        ...
        try:
            ...
            if old_analysis:
                ...
                project_index.dependencies = [
                    dep for dep in project_index.dependencies 
    ...
    async def find_references(self, project_index: ProjectIndex, symbol_name: str) -> List[Reference]:
        ...
        try:
            ...
            matching_symbols = [
                symbol for symbol in project_index.symbols.values()
    ...
    async def get_dependency_graph(self, project_index: ProjectIndex) -> DependencyGraph:
        ...
        try:
            ...
            dependency_graph.cycles = await self._detect_dependency_cycles(dependency_graph)
    ...
    async def _detect_dependency_cycles(self, graph: DependencyGraph) -> List[List[str]]:
