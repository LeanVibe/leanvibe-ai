...
class ConnectionManager:
    ...
    async def connect(
        ...
        logger.info(
            f"Client {client_id} {connection_type} connection with streaming. Total connections: {len(self.active_connections)}"
        )
    ...
    def _detect_client_type(self, user_agent: str) -> str:
        ...
        if (
            ...
            or "mozilla" in user_agent_lower
    ...
    def _create_default_preferences(
        ...
        if client_type == "ios":
            ...
            return ClientPreferences(
                client_id=client_id,
                enabled_channels=[
                    NotificationChannel.ANALYSIS,
                    NotificationChannel.VIOLATIONS,
                    NotificationChannel.AGENT,
                ],
