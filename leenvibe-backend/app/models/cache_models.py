...
class CacheEntry:
    ...
    def is_valid(self) -> bool:
        ...
        return (
            self.metadata.status == CacheStatus.VALID and
    ...
    def _update_average_access_time(self, access_time_ms: float):
        ...
        if self.average_access_time_ms == 0:
            ...
            self.average_access_time_ms = (
                (self.average_access_time_ms * (total_requests - 1) + access_time_ms) / total_requests
            )
...
class CacheWarming:
    ...
    def should_warm(self) -> bool:
        ...
        hours_since_warming = (datetime.now() - self.last_warming).total_seconds() / 3600
