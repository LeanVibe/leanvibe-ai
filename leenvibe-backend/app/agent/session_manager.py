...
from .enhanced_l3_agent import AgentDependencies
from .enhanced_l3_agent import EnhancedL3CodingAgent as L3CodingAgent
...
class SessionManager:
    ...
    async def create_session(
        self, client_id: str, workspace_path: str = ".", force_new: bool = False
    ) -> L3CodingAgent:
        ...
        try:
            ...
            dependencies = AgentDependencies(
                workspace_path=workspace_path, client_id=client_id, session_data={}
            )
    ...
    async def get_or_create_session(
        self, client_id: str, workspace_path: str = "."
    ) -> L3CodingAgent:
    ...
    async def process_message(
        self, client_id: str, message: str, workspace_path: str = "."
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result["session_info"] = {
                "client_id": client_id,
                "session_active": True,
                "interaction_count": self.session_metadata[client_id][
                    "interaction_count"
                ],
            }
    ...
    async def _save_all_sessions(self):
        ...
        try:
            save_tasks = [
                self._save_session(client_id) for client_id in self.sessions.keys()
            ]
