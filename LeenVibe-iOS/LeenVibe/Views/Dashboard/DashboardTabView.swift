...
struct DashboardTabView: View {
    ...
    var body: some View {
        TabView {
            ProjectDashboardView(projectManager: projectManager, webSocketService: webSocketService)
                .tabItem {
            ...
            MonitoringView(projectManager: projectManager, webSocketService: webSocketService)
                .tabItem {
